        ...
        <div class="list-group">
          ...
          <?php foreach($orders as $ord): ?>
            <a href="#" class="list-group-item">
              <p class="text-primary">ORD-N-<?= $ord->serialnum; ?></p>
              <div class="row">
                <div class="col-md-4">
                  <strong>Made on:</strong> <?= $ord->date; ?>
                </div>
                <div class="col-md-4">
                  <strong>Total Amount:</strong> <?= $ord->total_amount; ?>
                </div>
                <div class="col-md-4">
                  <strong>Order Status:</strong> <?= $ord->status; ?>
                </div>
              </div>
            </a>
          <?php endforeach; ?>
